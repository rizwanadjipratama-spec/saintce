...
export default function CTA() {
  ...
  return (
    <Section id="contact">
      <Container>
        <div className="orion-panel mx-auto max-w-[980px] px-6 py-8 text-center md:px-10 md:py-12">
          ...
          <p className="mx-auto mt-6 max-w-[680px] text-[1rem] leading-[1.8] text-[var(--muted)]">
            Orion is now structured so the website and admin control layer can evolve as one product instead of two disconnected builds.
          </p>

          <div className="mt-10 flex flex-col items-center gap-5">
            <button onClick={handleContactRoute} className="orion-button">
              Start an Orion Build
            </button>
            <a
