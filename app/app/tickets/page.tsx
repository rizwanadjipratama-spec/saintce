...
import { getTickets, getTicketComments, createTicket, addTicketComment } from "@/lib/tickets/service"
            ...
            <div className="flex h-full flex-col gap-4">
              ...
              {selected.status !== "closed" && selected.status !== "resolved" && (
                <div className="border-t border-(--border-soft) pt-4">
                  ...
                  />
                  <button onClick={handleReply} disabled={saving || !reply.trim()} className="saintce-button mt-3">
